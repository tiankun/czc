...
public class Village_hrAction extends BaseAction {
	...
	public String list(HttpServletRequest request) throws Exception {
		...
		String sql="select t.*from T_VILLAGE_HR t join t_didian td on t.city=td.id  where 1=1  and t.fid=?" +
				" order by t.id desc";
		...
		String sql1="select cast(avg(t.PRO_PROGRESS) as decimal(18,2))avg from T_VILLAGE_HR t join t_didian td on t.city=td.id  where 1=1"
				 +"/~ and t.fid ={fid} ~/ "
		...
		return "/village/VillageHr/list.jsp";
	}
	...
	public String show(HttpServletRequest request) throws Exception {	
		Map village_hr = dataBaseControl.getByBean(getMapObject(request));
		request.setAttribute("village_hr",village_hr);
		String biao_shi=request.getParameter("biao_shi");
		request.setAttribute("biao_shi",biao_shi);
		request.setAttribute("fid", request.getParameter("fid"));
		return "/village/VillageHr/show.jsp";
	}
	...
	public String create(HttpServletRequest request) throws Exception {
		...
		String biao_shi=request.getParameter("biao_shi");
		request.setAttribute("biao_shi",biao_shi);
		return "/village/VillageHr/create.jsp";
	}
	...
	public String save(HttpServletRequest request) throws Exception {
		...
		return "/village/Village_hr!list.do?fid="+fid;
	}
	...
	public String edit(HttpServletRequest request) throws Exception {
		...
		request.setAttribute("biao_shi",biao_shi);
		request.setAttribute("fid", request.getParameter("fid"));
		return "/village/VillageHr/edit.jsp";
	}
	...
	public String update(HttpServletRequest request) throws Exception {
		...
		String biao_shi=request.getParameter("biao_shi");
		request.setAttribute("biao_shi",biao_shi);
		return "/village/Village_hr!list.do?biao_shi="+biao_shi+"&fid="+fid;
	}
	...
	public String delete(HttpServletRequest request) throws Exception {
		...
		for(int i = 0; i < items.length; i++) {			
			dataBaseControl.executeSql("DELETE FROM T_VILLAGE_HR WHERE ID=?", new Object[]{items[i]});
		}
		return "/village/Village_hr!list.do?biao_shi="+biao_shi+"&fid="+fid;
	}	
}