...
public class Village_safe{
	

	//数据库相关字段
	private String pro_id;    //项目序号
	private String pro_name;    //项目名称
	private String pro_content;    //项目内容
	private String pro_scope;    //项目规模
	private java.math.BigDecimal pro_progress;    //项目进度
	private java.sql.Date stime;    //工程开工时间
	private java.sql.Date ftime;    //竣工日期
	private String constructionperiod;    //建设年限
	private String flag;    //是否竣工1————竣工0————未竣工
	private String id;    //id
	private Integer city;  //所属州市、县市区、乡镇Id（unit_id）
	private String shudi;  //所属州市、县市区、乡镇Id
	private Integer fid;  //对应村落基本信息表id
    //数据库相关字段 END
...
/**
	...
	public boolean equals(Object obj) {
		if(obj instanceof Village_safe == false) return false;
		if(this == obj) return true;
		Village_safe other = (Village_safe)obj;
