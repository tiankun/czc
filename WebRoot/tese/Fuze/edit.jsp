...
<form action="${pageContext.request.contextPath}/tese/Ts_fuze!save.do" method="post" name="form1">
    <table width="100%" border="1" cellspacing="1" cellpadding="1" class="myInput">
      <tr class="tHead">
        <td align="center" colspan="4"><strong>镇（乡）规划信息上报相关责任信息</strong></td>
      </tr>
      <tr>
		...
		<td width="15%" class="myInputTitle">填报人姓名</td>
