...
if(Validator.Validate(document.form1,3)){
	...
	if(chu_touzi>ke_touzi*1.1){
	    ...
	    document.form1.action="${pageContext.request.contextPath}/item/Nitem_rubbish!save.do?biao_shi="+biao_shi+"";
...
<body>
<form action="${pageContext.request.contextPath}/item/Nitem_rubbish!save.do" method="post" name="form1">
