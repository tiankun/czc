...
<input type="hidden" name="type" id="type" value="2"/>
	<table class="myInput" border="1" width="100%">
			...
			<tr>
				...
				<td colspan="3">
					<input type="text" id="name" name="name" value="${itemBuild.name}" msg="必填" datatype="Require">
				</td>
			</tr>
			<tr>
				<td align="center" class="myInputTitle" width="15%">
			...
			<tr>
				<td align="center" class="myInputTitle">
					<strong>其中污水厂计划投资（<span class="STYLE1">万元</span>）</strong>
				</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" id="tu_bianzhi" name="tu_bianzhi"
						value="${itemBuild.tu_bianzhi}">
				</td>
				<td align="center" class="myInputTitle">
					<strong>施工图审图单位</strong>
				</td>
				<td>
					<input type="text" id="tu_shencha" name="tu_shencha"
						value="${itemBuild.tu_shencha}">
				</td>
			</tr>
			<TR>
				<td align="center" class="myInputTitle">
				...
				<td>
					<input type="text" id="jianli_unit" name="jianli_unit" value="${itemBuild.jianli_unit}" />
				</td>
			</TR>
			<TR>
				<td align="center" class="myInputTitle">
