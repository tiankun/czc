...
function mylink(){
   parent.checkShow('${pageContext.request.contextPath}/item/Nitem_rubbish!list.do',4);
}
</script>
<style type="text/css">
<!--
...
<A href="${pageContext.request.contextPath}/item/Nitem_rubbish!createAdmin.do"><STRONG>====添加项目====</STRONG></A>
<A href="#" onclick="mylink();"><STRONG>====进入垃圾项目列表====</STRONG></A>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr class=tHead><td colspan="58" align="center"><strong>垃圾项目情况</strong></td>
  </tr> 
  <tr height="50">
     <td width="8%" class="myInputTitle">在建数</td>
     <td width="6%" align="center">${itemTongji2.shuliang}</td>
     <td width="8%" class="myInputTitle">设计规模-近期（<span class="STYLE10">吨/日</span>）</td>
     <td width="7%" align="center">${itemTongji2.clgm_jinqi}</td>
     <td width="8%" class="myInputTitle">设计规模-远期（<span class="STYLE10">吨/日</span>）</td>
     ...
     <td width="7%" class="myInputTitle">中转站设计规模（<span class="STYLE10">吨/日</span>）</td>
     <td width="6%" align="center">${itemTongji2.zhong_mo}</td>
  ...
  <tr height="50">
     ...
     <td class="myInputTitle">设计规模-近期（<span class="STYLE10">吨/日</span>）</td>
     <td align="center">${itemTongji1.clgm_jinqi}</td>
     <td class="myInputTitle">设计规模-远期（<span class="STYLE10">吨/日</span>）</td>
     ...
     <td class="myInputTitle">中转站设计规模（<span class="STYLE10">吨/日</span>）</td>
     <td align="center">${itemTongji1.zhong_mo}</td>
  ...
  <tr height="50">
     ...
     <td align="center">${itemTongji2.shuliang+itemTongji1.shuliang}</td>
     <td class="myInputTitle">累计处理规模-近期（<span class="STYLE10">吨/日</span>）</td>
     <td align="center">${itemTongji2.clgm_jinqi+itemTongji1.clgm_jinqi}</td>
     <td class="myInputTitle">累计处理规模-远期（<span class="STYLE10">吨/日</span>）</td>
     ...
     <td class="myInputTitle">累计中转站设计规模（<span class="STYLE10">吨/日</span>）</td>
     <td align="center">${itemTongji2.zhong_mo+itemTongji1.zhong_mo}</td>
