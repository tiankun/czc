...
function mylink(){
   parent.checkShow('${pageContext.request.contextPath}/item/Nitem_sewaga!list.do',4);
}
</script>
<style type="text/css">
<!--
...
<A href="${pageContext.request.contextPath}/item/Nitem_sewaga!createAdmin.do"><STRONG>====添加项目====</STRONG></A>
<A href="#" onclick="mylink();"><STRONG>====进入污水项目列表====</STRONG></A>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr class=tHead><td colspan="58" align="center"><strong>污水项目情况</strong></td>
  </tr> 
  <tr height="50">
