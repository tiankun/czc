...
<form action="${pageContext.request.contextPath}/village/Village_mode!edit.do" method="post">
  ...
  <TR>
	...
	<tr>
	    ...
	    <td  colSpan=4 align="center"> <input type="button"  value="返回列表" onclick="window.location='${pageContext.request.contextPath}/village/Village_mode!list.do?fid=${fid}&biao_shi=${biao_shi}'"/></td>				
	</table>
</form>
</body>
</html>