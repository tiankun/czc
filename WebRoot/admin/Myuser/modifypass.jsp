...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/styles/Admin_Style.css" rel="stylesheet" type="text/css">
        ...
        function validte(){
                 ...
                 document.ModifySysUser.action="${pageContext.request.contextPath}/admin/Myuser!modifyPass.do";
	...
	<body>
		...
		<br><br>
			<form method="POST" name="ModifySysUser">
				...
				<TABLE align=center border=1 borderColorDark=#ffffff borderColorLight=#035DB8 cellPadding=0 cellSpacing=0 width="39%">
					<TR  class="topbg">
