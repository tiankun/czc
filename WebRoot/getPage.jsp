...
window.location.href='<%=request.getContextPath()%>/site/Infor!getPage.do?inforname=<%=URLEncoder.encode(URLEncoder.encode((String)request.getAttribute("infor"),"UTF-8"),"UTF-8")%>&page='+s;
...
<tr bgcolor="#336699" height="37">
  ...
  <TABLE  cellSpacing=1 cellPadding=0 width="100%" border=1 >  
   <tr bgcolor="#CCCCCC" height="37">
    <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE5"><%=(String)request.getAttribute("infor")%></span></td>
      </tr>
    ...
    %>
                      ...
                      <TD>
                        ...
                        <A 
                        href="<%=request.getContextPath()%>/site/Infor!getPage.do?inforname=<%=URLEncoder.encode(URLEncoder.encode((String)request.getAttribute("infor"),"UTF-8"),"UTF-8")%>&page=<%=(Integer)request.getAttribute("page")-1%>">上一页 </A>&nbsp;|&nbsp;第
                        ...
                        <% }%></SELECT> 页&nbsp;|&nbsp;<A 
                        href="<%=request.getContextPath()%>/site/Infor!getPage.do?inforname=<%=URLEncoder.encode(URLEncoder.encode((String)request.getAttribute("infor"),"UTF-8"),"UTF-8")%>&page=<%=(Integer)request.getAttribute("page")+1%>">下一页</A> 
                   </DIV></TD></TR>
