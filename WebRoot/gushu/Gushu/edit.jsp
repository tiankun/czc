...
'<tr><td>类型：<select name="type" style="width:75px"><option value="全景照">全景照</option><option value="局部特写">局部特写</option></select>说明：<input type="text" name="remark" style="width:230px"/></td></tr></table></div>'); 
tb_remove();
i=i+1;
}
}
...
<form action="${pageContext.request.contextPath}/gushu/Gushu!update.do" method="post" name="form1">	
