<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*,java.io.*,com.alibaba.fastjson.JSONObject"%>
...
<%
	...
	if (false) {
		out.println(getError("权限认证失败，上传不成功!"));
	} else {
		//文件保存目录路径
		String savePath = pageContext.getServletContext().getRealPath("/")+ "upFile/";
		//文件保存目录URL
